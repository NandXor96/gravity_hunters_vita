...
# --- Variant A ---
a = synth_shot(
    dur=0.20, start_f=1200, end_f=280,
    attack=0.002, hold=0.012, decay=0.10, release=0.12,
    body_mix=(0.40, 0.55), click_amt=0.7, noise_amt=0.08,
    crush=1, dist=2.0, tail_lp_end=1800
)
path_shot2 = save_ogg("shot2.ogg", a, sr)

# --- Variant B ---
c = synth_shot(
    dur=0.2, start_f=1400, end_f=180,
    attack=0.002, hold=0.010, decay=0.1, release=0.14,
    body_mix=(0.40, 0.60), click_amt=0.75, noise_amt=0.10,
    crush=1, dist=2.4, tail_lp_end=1500
)
