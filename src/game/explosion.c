...
static Entity* explosion_create_entity(void* params) { (void)params; return NULL; }
static void explosion_destroy_entity(Entity* e) { if(!e) return; free(e); }
static void explosion_on_hit(Entity* e, Entity* hitter) { (void)e; (void)hitter; }
...
void explosion_destroy(Explosion* ex) { free(ex); }
